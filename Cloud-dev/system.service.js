...
var SystemService = /** @class */ (function () {
    ...
    Object.defineProperty(SystemService, "databaseInstance", {
    ...
    SystemService.register_middleware = function (type_middleware, descr_middleware) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, database_1.Database.query('CALL register_middleware(?, ?)', [type_middleware, descr_middleware])];
                    case 2:
                        _a.sent();
                        return [3 /*break*/, 4];
                    case 3:
                        error_1 = _a.sent();
                        console.error('Error registering middleware:', error_1);
