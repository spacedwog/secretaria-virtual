...
export class PatientService {
    static listPatients() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                yield Database.init(); // Certifique-se de inicializar a conexão
                const result = yield Database.query("SELECT * FROM patients");
    ...
    static addPatient(name, age, phone, email, address) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                yield Database.query('CALL add_patient(?, ?, ?, ?, ?)', [name, age, phone, email, address]);
            }
            catch (error) {
    ...
    static editPatient(patientId, fieldsToUpdate) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                yield Database.query(query, [...values, patientId]);
            }
            catch (error) {
    ...
    static deletePatient(patientId) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                yield Database.query('DELETE FROM patients WHERE patient_id = ?', [patientId]);
            }
            catch (error) {
