 ...
 *
 * @extends {NativeEventEmitter<ServerEvents, any>}
 */
export default class Server extends NativeEventEmitter<ServerEvents, any> {
    /**
    ...
    /** @protected @readonly */
    protected readonly _eventEmitter: import("react-native").NativeEventEmitter;
